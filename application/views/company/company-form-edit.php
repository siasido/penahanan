        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Profil Bengkel</h3>
            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12">
                    <div class="card card-body">
                        <h3 class="mb-0">Edit Data Profil Bengkel</h3>
                        <p class="text-muted mb-4 font-13"> Lengkapi form berikut untuk mengubah data bengkel:</p>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form action="<?=site_url('company/update')?>" method="post">
                                    <div class="row">
                                    <input type="hidden" name="idcompany" value="<?=$this->input->post('idcompany') ?? $data->idcompany?>">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                <label for="namacompany">Nama Bengkel</label>
                                                <input type="text" name="namacompany" class="form-control" id="namacompany" value="<?=$this->input->post('namacompany') ?? $data->namacompany?>">
                                                <div class="text-danger">
                                                    <small><?php echo form_error('namacompany'); ?></small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nohp" class="form-control" id="nohp" value="<?=$this->input->post('nohp') ?? $data->nohp?>">
                                                <div class="text-danger">
                                        ...
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="alamat" name="alamat" rows="2" ><?=$this->input->post('alamat') ?? $data->alamat ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <button type="submit" name="submit" class="btn btn-success waves-effect waves-light mr-2">Submit</button>
                                        <a href="<?=site_url('company/index')?>" class="btn btn-inverse waves-effect waves-light">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
