            ...
            <div class="container-fluid">
                <div class="col-md-12 col-lg-11">
                    <div class="card card-body">
                        ...
                        <p class="text-muted mb-4 font-13"> Lengkapi form berikut untuk mengubah data instansi:</p>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form action="<?=site_url('instansi/update')?>" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control custom-select <?=form_error('tipe') ? 'is-invalid' : null ?>" name="tipe" style="width: 100%; height:36px;" required>
                                                    ...
                                                    <?php $selectedTipe = ($this->input->post('tipe') ?? $data->tipe)?>
                                                    <option value="1" <?=($selectedTipe == 1 ? 'selected' : null) ?>> Kejaksaan</option>
                                                    <option value="2" <?=($selectedTipe == 2 ? 'selected' : null)?>> Kepolisian</option>
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="singkatan" class="form-control" id="singkatan" value="<?=($this->input->post('singkatan')?? $data->singkatan)?>">
                                                <div class="text-danger">
