        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">List Instansi</h3>
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-right">
                                    <?php if ($this->session->userdata('role') == 1 ) { ?>
                                        <a href="<?=site_url('instansi/add')?>" class="btn btn-info">
                                            Tambah Instansi
                                        </a>
                                    <?php } ?>
                                </div>
                                    ...
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            <?php foreach ($data as $key => $value) { ?>
                                                <tr>
                                                <td><?=($value->tipe == 1 ? 'Kejaksaan' : 'Kepolisian')?></td>
                                                <td><?=$value->nama?></td>
                                                ...
                                                <td>
                                                    <a href="<?=site_url('instansi/edit/'.encode_url($value->id))?>" class="btn waves-effect waves-light btn-warning"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    <a href="<?=site_url('instansi/delete/'.encode_url($value->id))?>" class="btn waves-effect waves-light btn-danger"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Hapus">
