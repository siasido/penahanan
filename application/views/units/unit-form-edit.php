        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Unit</h3>
            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12">
                    <div class="card card-body">
                        <h3 class="mb-0">Edit Data Satuan Barang</h3>
                        <p class="text-muted mb-4 font-13"> Lengkapi form berikut untuk mengubah data satuan barang:</p>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form action="<?=site_url('unit/update')?>" method="post">
                                    <div class="row">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                <label for="namaunit">Nama Satuan Barang</label>
                                                <input type="hidden" name="idunit" value="<?=$this->input->post('idunit') ?? $data->idunit?>">
                                                <input type="text" name="namaunit" class="form-control" id="namaunit" value="<?=$this->input->post('namaunit') ?? $data->namaunit?>">
                                                <div class="text-danger">
                                                    <small><?php echo form_error('namaunit'); ?></small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="2" ><?=$this->input->post('deskripsi') ?? $data->deskripsi ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <button type="submit" name="submit" class="btn btn-success waves-effect waves-light mr-2">Submit</button>
                                        <a href="<?=site_url('unit/index')?>" class="btn btn-inverse waves-effect waves-light">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
