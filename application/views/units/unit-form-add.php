            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12">
                    <div class="card card-body">
                        <h3 class="mb-0">Tambah Satuan Barang</h3>
                        <p class="text-muted mb-4 font-13"> Lengkapi form berikut untuk menambah satuan barang:</p>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form action="<?=site_url('unit/submit')?>" method="post">
                                    <div class="row">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                <input type="hidden" name="idunit">
                                                <label for="namaunit">Nama Satuan</label>
                                                <input type="text" name="namaunit" class="form-control" id="namaunit" value="<?=$this->input->post('namaunit')?>">
