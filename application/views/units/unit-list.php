        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Units</h3>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Satuan/Unit Barang</h4>
                                <div class="text-right">
                                    <a href="<?=site_url('unit/add')?>" class="btn btn-info"><i class="fas fa-plus"></i>
                                        ...
                                        <tbody>
                                            <?php foreach ($data as $key => $value) { ?>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn waves-effect waves-light btn-danger" onclick="showDeletAlert(<?=$value->idunit?>)" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
                        ...
                        <div class="modal-content modal-filled bg-danger">
                            <div class="modal-body p-4">
                                <div class="text-center">
                                    ...
                                    <form action="<?=site_url('unit/delete')?>" method="post">
                                        <input type="hidden" id="idunit2" value=""      name="idunit">
