            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12">
                    <div class="card card-body">
                        <h3 class="mb-0">Tambah Rekening</h3>
                        <p class="text-muted mb-4 font-13"> Lengkapi form berikut untuk menambah rekening:</p>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form action="<?=site_url('rekening/submit')?>" method="post">
                                    <div class="row">
                                        <input type="hidden" name="idrekening">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                <label for="namabank">Nama Bank</label>
                                                <input type="text" name="namabank" class="form-control" id="namabank" value="<?=$this->input->post('namabank')?>">
                                        ...
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="namaakun" class="form-control" id="namaakun" value="<?=$this->input->post('namaakun')?>">
                                                <div class="text-danger">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="norek" class="form-control" id="norek" value="<?=$this->input->post('norek')?>">
                                                <div class="text-danger">
