        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Bank Accounts</h3>
            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12">
                    <div class="card card-body">
                        ...
                        <p class="text-muted mb-4 font-13"> Lengkapi form berikut untuk mengubah data rekening:</p>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form action="<?=site_url('rekening/update')?>" method="post">
                                    <div class="row">
                                        <input type="hidden" name="idrekening" value="<?=$this->input->post('idrekening') ?? $data->idrekening?>">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                <label for="namabank">Nama Bank</label>
                                                <input type="text" name="namabank" class="form-control" id="namabank" value="<?=$this->input->post('namabank') ?? $data->namabank?>">
                                                <div class="text-danger">
                                                    <small><?php echo form_error('namabank'); ?></small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="namaakun" class="form-control" id="namaakun" value="<?=$this->input->post('namaakun') ?? $data->namaakun?>">
                                                <div class="text-danger">
                                                    <small><?php echo form_error('namaakun'); ?></small>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="norek" class="form-control" id="norek" value="<?=$this->input->post('norek') ?? $data->norek?>">
                                                <div class="text-danger">
                                    ...
                                    <div class="row">
                                        ...
                                        <a href="<?=site_url('rekening/index')?>" class="btn btn-inverse waves-effect waves-light">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
