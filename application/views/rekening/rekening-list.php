                                        ...
                                        <tbody>
                                            <?php foreach ($data as $key => $value) { ?>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn waves-effect waves-light btn-danger" onclick="showDeletAlert(<?=$value->idrekening?>)" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
                        ...
                        <div class="modal-content modal-filled bg-danger">
                            <div class="modal-body p-4">
                                <div class="text-center">
                                    ...
                                    <form action="<?=site_url('rekening/delete')?>" method="post">
                                        <input type="hidden" id="idrekening2" value=""      name="idrekening">
