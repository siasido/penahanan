            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Stock Out</h4>
                                <div class="text-right">
                                    <a href="<?=site_url('stock/outStockAdd')?>" class="btn btn-info"><i class="fas fa-plus"></i>
                                        Tambah Out Stock
                                    </a>
                                </div>
                                    ...
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            <?php foreach ($data as $key => $value) { ?>
                                                <tr>
                                                <td><?=date_indo($value->outstockdate)?></td>
