 ...
 <!-- Page wrapper  -->
                    ...
                    <div class="card card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form action="<?=site_url('stock/submitOutStock')?>" method="post">
                                    <div class="row">
                                        <input type="hidden" name="idpurchase">
                                        <div class="col-sm-12 col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                            
                                                <label for="outstockdate">Tanggal PO</label>
                                                <input type="date" name="outstockdate" class="form-control" id="outstockdate" value="<?=$this->input->post('outstockdate')?>">
                                                <div class="text-danger">
                                                    <small><?php echo form_error('outstockdate'); ?></small>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <a href="<?=site_url('stock/outStockList')?>" class="btn btn-inverse waves-effect waves-light">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        $("#idproduk").on("change", function (e) {
            ...
            $("#qty").attr({
                "max" : initStock,        // substitute your own
