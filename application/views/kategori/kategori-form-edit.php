        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Product Category</h3>
            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12">
                    <div class="card card-body">
                        <h3 class="mb-0">Edit Kategori Barang</h3>
                        <p class="text-muted mb-4 font-13"> Lengkapi form berikut untuk mengubah data kategori barang:</p>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form action="<?=site_url('kategori/update')?>" method="post">
                                    <div class="row">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="idkategori" value="<?=$this->input->post('idkategori') ?? $data->idkategori?>">
                                                <input type="text" name="namakategori" class="form-control" id="namakategori" value="<?=$this->input->post('namakategori') ?? $data->namakategori?>">
                                                <div class="text-danger">
                                                    <small><?php echo form_error('namakategori'); ?></small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3 mb-md-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <a href="<?=site_url('kategori/index')?>" class="btn btn-inverse waves-effect waves-light">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
