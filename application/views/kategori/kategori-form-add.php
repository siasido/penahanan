            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12">
                    <div class="card card-body">
                        ...
                        <p class="text-muted mb-4 font-13"> Lengkapi form berikut untuk menambah kategori barang:</p>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form action="<?=site_url('kategori/submit')?>" method="post">
                                    <div class="row">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                <label for="namakategori">Nama Kategori</label>
                                                <input type="hidden" name="idkategori">
                                                <input type="text" name="namakategori" class="form-control" id="namakategori" value="<?=$this->input->post('namakategori')?>">
