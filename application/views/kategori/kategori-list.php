                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-right">
                                    <a href="<?=site_url('kategori/add')?>" class="btn btn-info"><i class="fas fa-plus"></i>
                                        ...
                                        <tbody>
                                            <?php foreach ($data as $key => $value) { ?>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn waves-effect waves-light btn-danger" onclick="showDeletAlert(<?=$value->idkategori?>)" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
                            ...
                            <div class="modal-body p-4">
                                <div class="text-center">
                                    ...
                                    <form action="<?=site_url('kategori/delete')?>" method="post">
                                        <input type="hidden" id="idkategori2" value=""      name="idkategori">
