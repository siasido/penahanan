            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12">
                    <div class="card card-body">
                        ...
                        <p class="text-muted mb-4 font-13"> Lengkapi form berikut untuk mengubah data supplier:</p>
                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="idsupplier" value="<?=$this->input->post('idsupplier') ?? $data->idsupplier?>">
                                                <input type="text" name="namasupplier" class="form-control" id="namasupplier" value="<?=$this->input->post('namasupplier') ?? $data->namasupplier?>">
                                        ...
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="nohp" class="form-control" id="nohp" value="<?=$this->input->post('nohp') ?? $data->nohp?>">
                                                <div class="text-danger">
